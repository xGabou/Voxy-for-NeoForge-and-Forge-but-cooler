...
Thanks to j shelfwood for *prompting Claude* to make the original repo:
...
I do not own a Claude subscription, so do not be fooled by Claude showing up as a contributor. That only happened because the original repo was prompted through Claude.
